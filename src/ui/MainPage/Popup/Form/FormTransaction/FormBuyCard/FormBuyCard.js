...
import FormPhoneGame from './Content/FormPhoneGame'
...
export default class FormTransfer extends Component {
    ...
    _renderHeader() {
        return headerTransfer.map((item, index) => {
            return <React.Fragment key={index}>
                <div className="container_header-item"
                    id={"header-item-" + index}
                    onClick={() => this._changeStep(item.step)}
                >
                    <p className="container_header-item-title"
                        style={{
    ...
    _toggleLineActive = () => {
        ...
        const lineActive = document.getElementById("container_header-line-active-id")
             ...
             <p className='popup-title'>{data.title}</p>
                <div className="container">
                    <div className="container_header">
                        {this._renderHeader()}
                        <div id={'container_header-line-active-id'} className='container_header-line-active' />
                    </div>
                    <div className="container_content">
                    <FormPhoneGame step={this.state.step}/>
                    </div>
                </div>
            </Bound>
                )
